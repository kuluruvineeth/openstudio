...
terraform {
  backend "s3" {
    bucket = "kuluruvineeth-openstudio-terraform"
...
locals {
  upload-bucket-name = "openstudio-file-uploader"
}
...
resource "aws_cloudfront_distribution" "uploads" {
  origin {
    ...
    origin_id                = "openstudio-file-uploader"
  ...
  default_cache_behavior {
    ...
    target_origin_id = "openstudio-file-uploader"
