...
export function UploadDropZone({ propertyId, slug }: any) {
  ...
  const onDrop = (addedFiles: any) => {
    setFileStates([...fileStates, ...addedFiles]);
    setLoading(true);
    console.log(addedFiles);
    addedFiles.forEach((file: any) => {
      console.log("hello");
      ...
      setUploads((prevUploads) => [...prevUploads, uploader]);

      uploader.start();
    });
  };

  async function updateFileProgress(key: any, progress: any) {
  ...
  async function onFilesAdded(addedFiles: any) {
    setFileStates([...fileStates, ...addedFiles]);
    setLoading(true);

    const compressAndUpload = async (fileState: any) => {
      try {
        // Compress the image
